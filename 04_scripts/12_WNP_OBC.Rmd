...
lims1 <- rep(list(c(0.008, 0.015)), length(r_i)%/%2)
lims2 <- rep(list(c(0.012, 0.02)), length(r_i)%/%2+1)
lims <- c(lims1, lims2)
...
mask <- list(seq(6, 16), seq(6, 16), seq(6, 16), seq(6, 16), seq(6, 16), seq(6, 16), seq(6, 16), seq(6, 16), seq(6, 16))
