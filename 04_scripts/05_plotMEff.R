# plots V(r) from the computation of the effective mass for different values of tMax
...
for(beta in betaArray)
{
  ...
  plotwitherror(x, y, dy, col = colors[1], xlab = "r", ylab = "mEff", main = "Comparison of different tMax in AIC")
