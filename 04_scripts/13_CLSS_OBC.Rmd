...
r_L9 <- c(1, sqrt(2), sqrt(5), sqrt(8), 3, sqrt(10), sqrt(18), 5, sqrt(32), sqrt(40), sqrt(72),  sqrt(45), sqrt(98), sqrt(50), sqrt(128))

b_L3 <- c(1.4, 1.7, 2, 3, 5, 10, 15, 20, 25, 30, 40, 50, 60, 80, 90, 100)
b_L4 <- c(3.25, 4, 4.1, 4.15, 4.25, 4.3, 4.75, 5, 8, 10, 20, 30, 40, 60, 80)
b_L5 <- c(10, 11, 11.2, 11.4, 11.6, 11.8, 12, 20, 30, 40, 50, 60, 80, 100)
b_L6 <- c(5, 10, 15, 20, 25, 30, 35, 40)
b_L7 <- c(5, 5.5, 6, 6.5, 10, 15, 20, 25, 30, 35, 40)
b_L8 <- c(5, 10, 15, 20, 25, 30, 35, 40)
b_L9 <- c(5, 10, 15, 20, 25, 30, 35, 40)
```
