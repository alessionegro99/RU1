...
summary(fit.result)
plot(fit.result, main = paste0("E_0 for r=1 beta = ", invCoupling), xlab = "L/a", ylab = "E_0")
```
...
fit.result <- bootstrap.nlsfit(fn, c(1,1), value, x, bsamples)
summary(fit.result)
plot(fit.result, main = paste0("E_0 for r=sqrt(5) beta = ", invCoupling), xlab = "L/a", ylab = "E_0")
```
...
fit.result <- bootstrap.nlsfit(fn, c(1,1), value, x, bsamples)
summary(fit.result)
plot(fit.result, main = paste0("E_0 for r=sqrt(8) beta = ", invCoupling), xlab = "L/a", ylab = "E_0")
```
...
summary(fit.result)
plot(fit.result, main = paste0("r2F(r,beta) for r=1 beta =", invCoupling), xlab = "L/a", ylab = "r2F")
```
...
fit.result <- bootstrap.nlsfit(fn, c(0.3,1), value, x, bsamples)
summary(fit.result)
plot(fit.result, main = paste0("r2F(r,beta) for r=sqrt(5) beta =", invCoupling), xlab = "L/a", ylab = "r2F")
```
